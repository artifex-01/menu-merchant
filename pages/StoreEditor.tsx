...
const StoreEditor: React.FC = () => {
  ...
  return (
    <div className="pb-8">
      ...
      <div className="relative h-48 w-full group cursor-pointer bg-gray-100">
         <img src={formData.coverImage} className="w-full h-full object-cover" alt="Cover" />
         <div className="absolute inset-0 bg-black/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
            <div className="bg-white/90 px-3 py-2 rounded-full flex items-center gap-2 text-xs font-bold text-gray-800 shadow-lg">
      ...
      <div className="px-5 -mt-10 relative z-10">
         <div className="flex justify-between items-end">
             <div className="w-24 h-24 rounded-full border-4 border-white bg-white shadow-md overflow-hidden relative group cursor-pointer">
                 <img src={formData.logo} className="w-full h-full object-cover" alt="Logo" />
                 <div className="absolute inset-0 bg-black/30 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    <Upload size={20} className="text-white" />
                 </div>
             </div>
             <button className="bg-white border border-gray-200 text-gray-700 px-3 py-1.5 rounded-full text-xs font-bold shadow-sm flex items-center gap-1">
                <Eye size={12} /> Preview
             </button>
         </div>
      </div>
      ...
      <div className="p-5 space-y-6">
        ...
        <div className="space-y-4">
            <div>
                ...
                <input 
                    ...
                    className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 font-semibold focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all"
            ...
            <div className="grid grid-cols-2 gap-4">
                 <div>
                    ...
                    <input 
                        ...
                        className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-orange-500"
                    />
                 </div>
                 <div>
        ...
        <div>
            <div className="flex justify-between items-center mb-2">
                <label className="text-xs font-bold text-gray-500 uppercase ml-1">Pin Location</label>
                <button onClick={simulateLocate} className="text-[10px] text-orange-600 font-bold flex items-center gap-1 bg-orange-50 px-2 py-1 rounded-md">
                    <Locate size={10} /> Locate Me
                </button>
            </div>
            
            {/* Mock Interactive Map */}
            <div className="h-40 bg-gray-200 rounded-2xl overflow-hidden relative border border-gray-200 shadow-inner group">
                <div 
                ...
                <div className="absolute bottom-2 left-2 right-2 bg-white/90 backdrop-blur text-[10px] p-2 rounded-lg flex justify-between font-mono text-gray-600">
            ...
            <input 
                ...
                className="w-full mt-3 bg-white border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-orange-500"
